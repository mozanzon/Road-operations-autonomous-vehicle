...
const char* TK_LEFT_PWM = "lp";
const char* TK_RIGHT_PWM = "rp";
...
const char* TK_TURN_EXPECTED_TICKS = "tet";
const char* TK_ENCODER_ERROR = "et";
const char* TK_ENCODER_PID_KP = "ekp";
const char* TK_ENCODER_PID_KI = "eki";
const char* TK_ENCODER_PID_KD = "ekd";
const char* TK_ENCODER_PID_OUTPUT = "epo";
...
void printCompactStatus() {
  ...
  printCompactSeparator(TK_TURN_EXPECTED_TICKS); Serial.print(navTurnExpectedTicks);
  printCompactSeparator(TK_ENCODER_ERROR); Serial.print(lastEncoderErrorTicks, 2);
  printCompactSeparator(TK_ENCODER_PID_KP); Serial.print(encoderPidKp, 3);
  printCompactSeparator(TK_ENCODER_PID_KI); Serial.print(encoderPidKi, 3);
  printCompactSeparator(TK_ENCODER_PID_KD); Serial.print(encoderPidKd, 3);
  printCompactSeparator(TK_ENCODER_PID_OUTPUT); Serial.print(lastEncoderPidOutput);
